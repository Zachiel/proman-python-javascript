...
function boardBuilder(board) {
    // <input class="m-0 me-3 fs-4" data-board-id="${board.id}" value="${board.title}">
...
function statusBuilder(status, boardId) {
    return `<div class="col-12 col-sm-6 col-md-4 col-lg-3 board__status-column flex-column">
                <h4 class="board__status-header mb-0 d-flex align-items-center justify-content-center">
                    <input class="board__status-input" value="${status.title}" data-status-id="${status.id}" data-board-id="${boardId}"/>
                </h4>
...
function cardBuilder(card) {
    return `<div class="card" data-card-id="${card.id}" data-card-order="${card.order}">
                <div class="card-body">
                    <h5 class="card-title">
                        <input type="text" value="${card.title}" data-card-id="${card.id}"   class="board__card-title"/>
                    </h5>
